 ...
 * @author Uzair Rehman
 */
public class Add_Voter extends javax.swing.JFrame {

    /**
     * Creates new form Add_Voter
     */
    public Add_Voter() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Enter the Voter Info");
	...
	private int Add_Voter()
	{
      ...
      {
          JOptionPane.showMessageDialog(this, "Fields cannot be empty... Please write your name and password and submit again");
          this.setVisible(true);
		  return 0;
      }
        if (voters.addVoter(id, name, address, dob, pswrd))
        {
       ...
       {
           JOptionPane.showMessageDialog(this, "Voter with similar CNIC exists!!! \n A voter cannot be added twice!!");
           this.setVisible(true);
		   return 0;
       }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Add_Voter.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
