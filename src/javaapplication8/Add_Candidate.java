...
public class Add_Candidate extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Enter the Candidate Info");
...
public int Perform()
{
    ...
    Poling pol = Poling.getInstance();
        ...
        if (pol.isPolingFlag())
        {
            JOptionPane.showMessageDialog(null, "Candidates cannot be updated during polling");
            return i;
        }        // TODO add your handling code here:
        ...
        CandidateList candList = CandidateList.getInstance();
      ...
      else  if (candList.addCandidate(id, name, address, dob, type))
        {
            candList.writeFile();
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Add_Candidate().setVisible(true); //Make the screen visible
